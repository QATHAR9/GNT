    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="bg-black border border-gray-800 rounded-xl p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">Buying Price (KES) *</label>
              <input
                type="number"
                min="0"
                step="0.01"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">Selling Price (KES) *</label>
              <input
                type="number"
                min="0"
                step="0.01"
